...
public class Test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topic.setText(R.string.Statment);
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent(Test.this, Lecture.class);
        ...
        button_back_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent(Test.this, Levels.class);
                    startActivity(intent);finish();
                }catch (Exception e){
        ...
        button_good.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    Intent intent = new Intent(Test.this, Lecture2.class);
                    startActivity(intent);finish();
                }catch (Exception e){
        ...
        final Animation a = AnimationUtils.loadAnimation(Test.this, R.anim.alpha);


        question_first_level = 0;

        question.setText(array.questions1[question_first_level]);
        //fdbnlfdbmd
